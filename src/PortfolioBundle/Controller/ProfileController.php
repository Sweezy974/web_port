...
use PortfolioBundle\Entity\Profile;
...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $profiles = $em->getRepository('PortfolioBundle:Profile')->findAll();

        return $this->render('@PortfolioBundle/Resources/views/admin/profile/index.html.twig', array(
            'profiles' => $profiles,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $admin = $this->getUser();
        $admin->getId();
        // si l'admin a déjà un profil
        $profileExist = $em->getRepository('PortfolioBundle:Profile')->findby(array('admin'=>$admin));
        if ($profileExist) {
          return $this->redirectToRoute('admin_index');
        }
        $profile = new Profile();
        $form = $this->createForm('PortfolioBundle\Form\ProfileType', $profile);
        ...
        return $this->render('@PortfolioBundle/Resources/views/admin/profile/new.html.twig', array(
            'profile' => $profile,
    ...
    public function showAction(Profile $profile)
    {
        ...
        return $this->render('@PortfolioBundle/Resources/views/admin/profile/show.html.twig', array(
            'profile' => $profile,
    ...
    {
        $deleteForm = $this->createDeleteForm($profile);
        $editForm = $this->createForm('PortfolioBundle\Form\ProfileType', $profile);
        ...
        return $this->render('@PortfolioBundle/Resources/views/admin/profile/edit.html.twig', array(
            'profile' => $profile,
